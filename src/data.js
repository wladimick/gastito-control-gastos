export const CATEGORIES = [
  { id: "agua", label: "Agua", icon: "💧", color: "#4DA3FF" },
  { id: "ahorro", label: "Ahorro", icon: "💾", color: "#2196F3" },
  { id: "arriendo", label: "Arriendo", icon: "🏡", color: "#8BC34A" },
  { id: "aseo_limpieza", label: "Aseo / Limpieza", icon: "🧹", color: "#68B0AB" },
  { id: "auto", label: "Auto", icon: "🚗", color: "#607D8B" },
  { id: "bencina", label: "Bencina", icon: "⛽", color: "#E07A5F" },
  { id: "calefaccion", label: "Calefacción / Parafina", icon: "♨️", color: "#C96C4B" },
  { id: "caja_chica", label: "Caja chica", icon: "💵", color: "#A98467" },
  { id: "comida", label: "Comida", icon: "🍽", color: "#F2CC8F" },
  { id: "almacen_barrio", label: "Almacén de barrio", icon: "🧺", color: "#8FB996" },
  { id: "cuidado_personal", label: "Cuidado personal", icon: "✂️", color: "#D88C9A" },
  { id: "costos_financieros", label: "Costos financieros", icon: "🏦", color: "#546E7A" },
  { id: "comision_bancaria", label: "Comisión bancaria", icon: "🏦", color: "#546E7A" },
  { id: "deuda", label: "Deuda", icon: "📋", color: "#F44336" },
  { id: "dividendo", label: "Dividendo", icon: "🏠", color: "#8D6E63" },
  { id: "educacion", label: "Educación", icon: "📚", color: "#3F51B5" },
  { id: "estacionamiento", label: "Estacionamiento", icon: "🅿️", color: "#78909C" },
  { id: "familia", label: "Familia", icon: "👨‍👩‍👧", color: "#E91E63" },
  { id: "feria", label: "Feria", icon: "🥬", color: "#77A65A" },
  { id: "farmacia", label: "Farmacia", icon: "💊", color: "#9B89B3" },
  { id: "gas", label: "Gas", icon: "🔥", color: "#FF8A65" },
  { id: "hogar", label: "Hogar", icon: "🏠", color: "#B07156" },
  { id: "hobby_coleccionables", label: "Hobby / Coleccionables", icon: "🃏", color: "#8064C8" },
  { id: "imprevistos", label: "Imprevistos", icon: "⚠️", color: "#9E9E9E" },
  { id: "internet", label: "Internet", icon: "🌐", color: "#5C6BC0" },
  { id: "luz", label: "Luz", icon: "💡", color: "#FBC02D" },
  { id: "mascota", label: "Mascota", icon: "🐾", color: "#795548" },
  { id: "mascotas", label: "Mascotas", icon: "🐾", color: "#795548" },
  { id: "mascota_molly", label: "Mascotas · Molly", icon: "🐾", color: "#B16C7A" },
  { id: "mascota_terry", label: "Mascotas · Terry", icon: "🐾", color: "#6B8E78" },
  { id: "panaderia", label: "Panadería", icon: "🥖", color: "#C69C6D" },
  { id: "por_cobrar", label: "Por cobrar", icon: "💵", color: "#4CAF50" },
  { id: "por_pagar", label: "Por pagar", icon: "💸", color: "#FF9800" },
  { id: "prestamo", label: "Préstamo", icon: "🤝", color: "#FF9800" },
  { id: "prestamos", label: "Préstamos", icon: "🤝", color: "#FF9800" },
  { id: "regalo", label: "Regalo", icon: "🎁", color: "#E91E63" },
  { id: "regalos", label: "Regalos", icon: "🎁", color: "#E91E63" },
  { id: "ropa", label: "Ropa", icon: "👕", color: "#AB47BC" },
  { id: "salidas", label: "Salidas", icon: "🎟️", color: "#7E57C2" },
  { id: "entretenimiento_salidas", label: "Entretenimiento / Salidas", icon: "🎬", color: "#7E57C2" },
  { id: "salud", label: "Salud", icon: "🩺", color: "#00BCD4" },
  { id: "servicios", label: "Servicios", icon: "⚡", color: "#FF5722" },
  { id: "sueldo", label: "Sueldo", icon: "💰", color: "#27AE60" },
  { id: "supermercado", label: "Supermercado", icon: "🛒", color: "#81B29A" },
  { id: "suscripciones", label: "Suscripciones", icon: "📺", color: "#C77DFF" },
  { id: "tag_peajes", label: "TAG / Peajes", icon: "🛣️", color: "#90A4AE" },
  { id: "transferencias", label: "Transferencias", icon: "↔️", color: "#78909C" },
  { id: "transporte", label: "Transporte", icon: "🚇", color: "#6D9DC5" },
  { id: "vehiculo", label: "Vehículo", icon: "🚙", color: "#455A64" },
