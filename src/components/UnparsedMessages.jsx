...
import { Card, IconBtn, Select } from './ui'
import { Icon, fmtCLP, relDate, timeOnly } from '../lib/helpers'
...
export default function UnparsedMessages({ unparsed, onResolve, onDiscard }) {
            ...
            <Card key={m.id} padding="p-0">
              <div className="p-5 flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-1.5 text-[11px] text-[var(--muted)] font-mono flex items-center gap-2 flex-wrap">
                    ...
                    {m.guess && (
                      <>
                        ...
                        <span className="inline-flex items-center gap-1 text-[var(--ink-2)]">
                          ...
                          {m.guess.category && <span>{CATEGORIES.find(c => c.id === m.guess.category)?.label}</span>}
