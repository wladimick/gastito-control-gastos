// Mock data para el prototipo de Control de Gastos
const CATEGORIES = [
...
const today = new Date("2026-05-13T20:15:00");
...
// Historial mensual (para reportes)
const MONTHLY_HISTORY = [
  ...
  { month: "May 2026", total:  null /* se calcula */ },
];
...
// Ingresos (sueldo mensual + puntuales)
const INCOME = [
...
// Por cobrar (dinero que me deben)
const RECEIVABLES = [
...
// Presupuestos mensuales por categoría (CLP)
const BUDGETS = {
  bencina:        60000,
  supermercado:  150000,
  comida:        120000,
...
// Auditoría: log de acciones (más reciente primero)
const AUDIT_LOG = [
...
// Deudas en cuotas (compras grandes financiadas en N cuotas)
// startMonth = "YYYY-MM" en que se cargó la 1ª cuota
const INSTALLMENT_DEBTS = [
  // Todas las cuotas se auto-cobran el día 5 (día de pago de sueldo)
...
window.MOCK = { CATEGORIES, BANKS, PAYMENT_METHODS, EXPENSES, MONTHLY_HISTORY, UNPARSED, BOT_CHAT, INCOME, RECEIVABLES, RECURRING, BUDGETS, AUDIT_LOG, INSTALLMENT_DEBTS, TODAY: today };
